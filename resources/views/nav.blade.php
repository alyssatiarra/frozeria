...
<body>
    ...
    <nav>
        ...
        <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" href="{{route('product.index')}}" id="nav-product">Dashboard</a>
        <a class="menu-item nav-link {{ Request::is('category') ? 'active' : '' }}" href="{{ route('category.index') }}" id="nav-category">Kategori</a>
        <a class="nav-link {{ Request::is('help') ? 'active' : '' }}" href="{{ route('help') }}" id="nav-bantuan">Bantuan</a>
        <span class="nav-spacer"></span>
        @if (Request::is('/'))
        <a href="{{ route('product.create') }}" class="btn-nav " style="text-decoration: none;">
            ＋ Tambah Barang
        </a>
        @elseif(Request::is('category'))
        <a href="{{ route('category.create') }}" class="btn-nav " style="text-decoration: none;">
            ＋ Tambah Kategori
        </a>
        @endif
    </nav>
